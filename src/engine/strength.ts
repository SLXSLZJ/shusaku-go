...
/** 认真度 1–10 档：低档在近似候选中抽签（会下出人味的缓手），高档永远最强手。 */
export const STRENGTH_LEVELS: StrengthLevel[] = [
  ...
  { label: '顶尖业余', visits: 4000, maxTimeMs: 20000, pickMode: 'best' },
  { label: '职业低段', visits: 8000, maxTimeMs: 30000, pickMode: 'best' },
  { label: '认真', visits: 16000, maxTimeMs: 45000, pickMode: 'best' },
